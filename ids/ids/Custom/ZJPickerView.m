...
- (void)initDefaultConfig
{
    ...
    self.selectRowTitleAttribute = @{NSForegroundColorAttributeName : RGBCOLOR(20, 124, 228), NSFontAttributeName : [UIFont systemFontOfSize:20.0f]};
...
- (void)initSubViews
{
    ...
    [sureBtn setTitleColor:RGBCOLOR(20, 124, 228) forState:UIControlStateNormal];
                 ...
                 completion:(nullable void(^)(NSString * _Nullable selectContent))completion
{
    ...
    [self sharedView].tipLabel.text = tipStr;
